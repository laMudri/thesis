...
\begin{mathpar}
  \ebrule{%
    ...
    \hypo{\Delta \vdash A}
    \infer4[Rename]{\Gamma \vdash A}
  }
  \and
  \ebrule{%
    \hypo{\Gamma \vdash \Delta_1}
    \delims{\left\lfloor}{\right.}
    \hypo{\cdots}
    \hypo{\Gamma \vdash \Delta_n}
    \delims{\left.}{\right\rfloor}
    \hypo{\Delta \vdash A}
    \infer4[Subst]{\Gamma \vdash A}
  }
\end{mathpar}

As an example of applying \TirName{Subst}, consider the example below.
