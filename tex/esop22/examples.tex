...
\begin{proof}
  ...
  That is, $b$ is a Kripke function yielding $\C$-computations, and we want to
  apply it so as to get a $\C\,\plr{\Gamma, \Delta}\,A$.
  Let $\grP\gamma = \Gamma$ and $\grQ\delta = \Delta$.
  The $\Box^r$ in the type of $b$ allows us to rename $\Gamma$ to
  $\Gamma, \gr0\delta$.
