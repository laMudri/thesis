...
Terms defined like this are difficult to write by hand, due to the
need for proofs that the usage contexts are handled correctly for the rules used.
We give an example of a hand-written term in \cref{sec:explicit-term}, and will
see a way of automating the necessary proofs in \cref{sec:usage-elaborator}.
