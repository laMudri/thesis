...
$\oc\gr\omega$ forms a comonad. \AgdaInductiveConstructor{!E$'$} and
\AgdaInductiveConstructor{!I$'$} are variants on
\AgdaInductiveConstructor{!E} and \AgdaInductiveConstructor{!I} with
...
\ExecuteMetaData[\HeavyItex]{cojoin-explicit} Writing terms like this
